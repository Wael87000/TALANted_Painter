...
st.set_page_config(
    page_title="TALANted_AI_Painter", layout="wide"
)

def load_image(image_buffer, image_size=(512, 512)): #image_size=(512, 256)
...
def st_ui():
    st.title("TALANted AI Painter")
    st.write('This engine is based on Fast Style Transfer Learning. It is a simple, fast and amazing tool to generate AI based ART.')
    image_upload1 = st.sidebar.file_uploader("Load your content image here",type=["jpeg", "png", "jpg"], accept_multiple_files=False, key=None, help="Upload the image whom you want to style")
    image_upload2 = st.sidebar.file_uploader("Load your style image here",type=["jpeg", "png", "jpg"], accept_multiple_files=False, key=None, help="Upload the image whose style you want")
